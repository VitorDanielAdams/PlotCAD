...
const RegistrationTab = ({ registration, updateRegistration }: Props) => (
  <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
    <div>
      <label className="block text-xs font-medium text-gray-500 mb-1">Nome da matrícula</label>
      <input
        type="text"
    ...
    <div>
      <label className="block text-xs font-medium text-gray-500 mb-1">Número de registro</label>
      <input
        type="text"
    ...
    <div>
      <label className="block text-xs font-medium text-gray-500 mb-1">Cliente / Serviço</label>
      <input
        type="text"
