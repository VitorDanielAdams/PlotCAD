		...
		<div className="min-h-screen bg-white">
			...
			<div className="max-w-7xl mx-auto px-6 py-6">
				{loading ? (
					...
					<div className="text-center py-12 text-gray-500">Nenhum módulo encontrado</div>
				) : (
					<div className="bg-white border border-gray-200 rounded-lg divide-y divide-gray-200">
						{modules.map((mod) => (
							<div key={mod.id} className="flex items-center justify-between px-6 py-4">
								<div className="flex items-center gap-4">
									<div
										className={`w-3 h-3 rounded-full ${mod.isActive ? "bg-[#22c55e]" : "bg-gray-300"}`}
									/>
									<div>
